...
import random
import numpy as np
from src.cpd_segmentation_valid import create_targets_and_contexts

class XTrendDatasetValid(Dataset):
...
if __name__ == "__main__":
    ...
    dataloader_valid  = DataLoader(dataset_valid, batch_size = 20,  pin_memory = True, shuffle=True)